          ...
          <TabsContent value="ojs" className="space-y-4">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="mt-6">
                  <Link
                    href={isAnnual ? "https://shop.paideiahosting.net/shop/ojs-basic-m-ojs-hosting-basic-monthly-146?plan_id=2" : "https://shop.paideiahosting.net/shop/ojs-basic-m-ojs-hosting-basic-monthly-146"}
              ...
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm relative">
                ...
                <div className="mt-6">
                  <Link
                    href={isAnnual ? "https://shop.paideiahosting.net/shop/ojs-pro-m-ojs-hosting-professional-monthly-147?plan_id=2" : "https://shop.paideiahosting.net/shop/ojs-pro-m-ojs-hosting-professional-monthly-147"}
                    className="inline-flex h-10 w-full items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  >
                    Get Started
                  </Link>
              ...
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="mt-6">
                  <Link
                    href={isAnnual ? "https://shop.paideiahosting.net/shop/ojs-ent-m-ojs-hosting-enterprise-monthly-148?plan_id=2" : "https://shop.paideiahosting.net/shop/ojs-ent-m-ojs-hosting-enterprise-monthly-148"}
                    className="inline-flex h-10 w-full items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  >
                    Get Started
                  </Link>
          ...
          <TabsContent value="omp" className="space-y-4">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="mt-6">
                  <Link
                    href={isAnnual ? "https://shop.paideiahosting.net/shop/omp-basic-m-omp-hosting-basic-monthly-152?plan_id=2" : "https://shop.paideiahosting.net/shop/omp-basic-m-omp-hosting-basic-monthly-152"}
                    className="inline-flex h-10 w-full items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  >
                    Get Started
                  </Link>
              ...
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm relative">
                ...
                <div className="mt-6">
                  <Link
                    href={isAnnual ? "https://shop.paideiahosting.net/shop/omp-pro-m-omp-hosting-professional-monthly-153?plan_id=2" : "https://shop.paideiahosting.net/shop/omp-pro-m-omp-hosting-professional-monthly-153"}
                    className="inline-flex h-10 w-full items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  >
                    Get Started
                  </Link>
              ...
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="mt-6">
                  <Link
                    href={isAnnual ? "https://shop.paideiahosting.net/shop/omp-ent-m-omp-hosting-enterprise-monthly-154?plan_id=2" : "https://shop.paideiahosting.net/shop/omp-ent-m-omp-hosting-enterprise-monthly-154"}
                    className="inline-flex h-10 w-full items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  >
                    Get Started
                  </Link>
          ...
          <TabsContent value="dataverse" className="space-y-4">
            ...
            <div className="grid gap-6 md:grid-cols-2 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm relative">
                ...
                <div className="mt-6">
                  <Link
                    href={isAnnual ? "https://shop.paideiahosting.net/shop/repo-pro-m-repository-hosting-professional-monthly-158?plan_id=2" : "https://shop.paideiahosting.net/shop/repo-pro-m-repository-hosting-professional-monthly-158"}
                    className="inline-flex h-10 w-full items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  >
                    Get Started
                  </Link>
              ...
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="mt-6">
                  <Link
                    href={isAnnual ? "https://shop.paideiahosting.net/shop/repo-ent-m-repository-hosting-enterprise-monthly-159?plan_id=2" : "https://shop.paideiahosting.net/shop/repo-ent-m-repository-hosting-enterprise-monthly-159"}
                    className="inline-flex h-10 w-full items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  >
                    Get Started
                  </Link>
          ...
          <TabsContent value="atom" className="space-y-4">
            ...
            <div className="grid gap-6 md:grid-cols-2 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm relative">
                ...
                <div className="mt-6">
                  <Link
                    href={isAnnual ? "https://shop.paideiahosting.net/shop/atom-pro-m-atom-hosting-professional-monthly-162?plan_id=2" : "https://shop.paideiahosting.net/shop/atom-pro-m-atom-hosting-professional-monthly-162"}
                    className="inline-flex h-10 w-full items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  >
                    Get Started
                  </Link>
              ...
              <div className="flex flex-col rounded-lg border bg-background p-6 shadow-sm">
                ...
                <div className="mt-6">
                  <Link
                    href={isAnnual ? "https://shop.paideiahosting.net/shop/atom-ent-m-atom-hosting-enterprise-monthly-163?plan_id=2" : "https://shop.paideiahosting.net/shop/atom-ent-m-atom-hosting-enterprise-monthly-163"}
                    className="inline-flex h-10 w-full items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                  >
                    Get Started
                  </Link>
